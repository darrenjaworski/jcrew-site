...
const images: ImageData[] = [
    ...
    {
        url: masterclass,
        credit: "Miki Galloway - Masterclass at Lyric Theatre of Oklahoma with Natalie Cordone",
        mode: HeroImageMode.light,
    },
];
...
const HeroHeading = styled.h1<{ mode: HeroImageMode }>`
    ...
    font-weight: 400;
    color: ${(props) =>
        props.mode === HeroImageMode.dark ? "white" : "black"};
...
export const Hero = () => {
    ...
    useEffect(() => {
        const interval = setInterval(() => {
            ...
            setImageRef((index) =>
                index + 1 >= numberOfImages ? 0 : index + 1
            );
        }, BG_LOOP_TIME);
